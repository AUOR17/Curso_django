        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=200, verbose_name="Nombre del Objetivo"
                    ),
                ),
                (
                    "race_class",
                    models.CharField(
                        max_length=100, verbose_name="Raza/Clase (Job Title)"
                    ),
                ),
                (
                    "contact_email",
                ...
                (
                    "days_in_funnel",
                    models.IntegerField(default=0, verbose_name="Días de Rastreo"),
                ),
                (
                    "emails_sent",
                    models.IntegerField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("TABERNA", "Taberna (Nuevo)"),
                            ("EXPLORACION", "Exploracion (En Proceso)"),
                            ("COMBATE", "Combate (Negociacion)"),
                            ("TESORO", "Tesoro (Cerrado o Ganado)"),
                            ("CEMENTERIO", "Cementerio (Cerrado Perdido)"),
                        ],
                        default="TABERNA",
                        max_length=20,
                    ),
